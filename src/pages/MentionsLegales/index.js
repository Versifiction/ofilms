    ...
    <>
      ...
      <div className="container" style={{ textAlign: "justify" }}>
        ...
        <p>
          ...
          visiteurs du site : <a href="http://www.ofilms.fr">www.ofilms.fr</a>{" "}
        ...
        <p>
          ...
          <br />
          Le Propriétaire est : <strong>Marc Charpentier</strong>
          <br />
          Adresse postale du propriétaire : <strong>-</strong>
          <br />
          <br />
          Le Créateur du site est : <strong>Marc Charpentier</strong>
          <br />
          Le Responsable de la publication est :{" "}
          <strong>Marc Charpentier</strong>
          <br />
          Contacter le responsable de la publication :{" "}
          <strong>marc_charpentier@hotmail.fr</strong>
          <br />
          Le responsable de la publication est une
          <strong> personne physique</strong>
          <br />
          <br />
          Le Webmaster est : <strong>Marc Charpentier</strong>
          <br />
          Contacter le Webmaster :{" "}
          <strong>
            <a href="mailto:marc_charpentier@hotmail.fr?subject=Contact a partir des mentions légales via le site www.ofilms.fr">
              marc_charpentier@hotmail.fr
            </a>
          </strong>
          <br />
          ...
          <a href="https://editioneo.com/formalites/declaration-cnil">
            déclaration CNIL
          </a>
        </p>
        <br />
        ...
        <p>
          ...
          <a href="http://www.ofilms.fr">www.ofilms.fr</a>.
          <br />
          Le site <strong>www.ofilms.fr</strong>
          ...
          autres utilisateurs qu'envers le webmaster du site www.ofilms.fr. Le
          site www.ofilms.fr est mis à jour régulièrement par Marc Charpentier.
          <br />
          Marc Charpentier s’efforce de fournir sur le site www.ofilms.fr des
        ...
        <p>
          ...
          <br />
          <br />
          Le site www.ofilms.fr est par principe accessible aux utilisateurs
          24/24h, 7/7j, sauf interruption, programmée ou non, pour les besoins
          de sa maintenance ou en cas de force majeure. En cas d’impossibilité
          d’accès au service, www.ofilms.fr s’engage à faire son maximum afin de
          rétablir l’accès au service et s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
          N’étant soumis qu’à une obligation de moyen, www.ofilms.fr ne saurait
          être tenu pour responsable de tout dommage, quelle qu’en soit la
        ...
        <p>
          <br />
          Marc Charpentier est propriétaire exclusif de tous les droits de
          ...
          <br />
          Toute reproduction totale ou partielle du site www.ofilms.fr,
          représentation, modification, publication, adaptation totale ou
          partielle de l'un quelconque de ces éléments, quel que soit le moyen
          ou le procédé utilisé, est interdite, sauf autorisation écrite
          préalable de Marc Charpentier, propriétaire du site à l'email :
          marc_charpentier@hotmail.fr, à défaut elle sera considérée comme
        ...
        <p>
          ...
          <br />
          <br />
          Le site www.ofilms.fr contient un certain nombre de liens hypertextes
          vers d’autres sites (partenaires, informations …) mis en place avec
          l’autorisation de Marc Charpentier. Cependant, Marc Charpentier n’a
          ...
          www.ofilms.fr, un ou des cookies sont susceptibles de s’installer
          automatiquement sur son ordinateur par l'intermédiaire de son logiciel
          de navigation. Un cookie est un bloc de données qui ne permet pas
          d'identifier l'utilisateur, mais qui enregistre des informations
          relatives à la navigation de celui-ci sur le site. <br />
        ...
        <p>
          Sur le site www.ofilms.fr, Marc Charpentier ne collecte des
          ...
          services proposés par le site www.ofilms.fr. L'utilisateur fournit ces
          informations en toute connaissance de cause, notamment lorsqu'il
          procède par lui-même à leur saisie. Il est alors précisé à
          l'utilisateur du site www.ofilms.fr l’obligation ou non de fournir ces
          informations.
          <br />
          ...
          le concernant. Pour l’exercer, adressez votre demande à www.ofilms.fr
          par email :{" "}
          <strong>
            <a href="mailto:marc_charpentier@hotmail.fr?subject=Contact ï¿½ partir des mentions lï¿½gales via le site www.ofilms.fr">
              marc_charpentier@hotmail.fr
            </a>
          </strong>{" "}
        ...
        <p>
          Aucune information personnelle de l'utilisateur du site www.ofilms.fr
          ...
          rachat du site www.ofilms.fr et de ses droits autorise Marc
          Charpentier à transmettre les dites informations à l'éventuel
          ...
          du site www.ofilms.fr.
          <br />
          Le site www.ofilms.fr est déclaré à la CNIL sous le numéro Aucune
          déclaration CNIL car pas de recueil de données personnelles.
        </p>
